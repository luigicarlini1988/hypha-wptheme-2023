...
<main class="dark-theme">
    <section class="home-header">
        ...
        <div class="top-social">
            ...
            <a href="https://discord.gg/JfM7Tv3MQk" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/icons/discord.svg" /></a>
                ...
                <div class="feature-animations">
                    ...
                    <div id="featureset3" class="flex gap-20 wrap">
                        ...
                        <div id="treasuryicon" class="icon medium clickable">
                            <a href="<?php echo home_url(); ?>/features/recognize-and-reward/">
                                <div class="flex wrap justify-center">
                                    <img src="<?php echo get_template_directory_uri(); ?>/img/icons/treasury.svg" />
                                    <span>Treasury</span>
                                </div>
    ...
    <section id="pop-up">
        <div class="area flex align-center justify-center">
            <div class="form-wrap pop-inside">
                <div class="wrappo">
                    <div id="pop-close">X</div>
                    <p class="subtitle">Stay ahead of the curve</p>
                    <p class="title-56 white">Subscribe to <br />Hypha's Newsletter</p>

                    <form autocomplete="false" role="form" method="post" action="https://mautic.hypha.earth/form/submit?formId=23" id="mauticform_popupnewslettersignup2023" data-mautic-form="popupnewslettersignup2023" enctype="multipart/form-data">
                        <div class="mauticform-error" id="mauticform_popupnewslettersignup2023_error"></div>
                        <div class="mauticform-message" id="mauticform_popupnewslettersignup2023_message"></div>
                        <div class="mauticform-innerform">

                            <div class="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">

                                <div id="mauticform_popupnewslettersignup2023_email" data-validate="email" data-validation-type="email" class="mauticform-row mauticform-email mauticform-field-1 mauticform-required wrap-area full">
                                ...
                                <div id="mauticform_popupnewslettersignup2023_first_name" data-validate="first_name" data-validation-type="text" class="mauticform-row mauticform-text mauticform-field-2 mauticform-required wrap-area half">
                                ...
                                <div id="mauticform_popupnewslettersignup2023_what_is_5_times_4" data-validate="what_is_5_times_4" data-validation-type="captcha" class="mauticform-row mauticform-text mauticform-field-3 mauticform-required wrap-area half">
                                ...
                                <div id="mauticform_popupnewslettersignup2023_privacy_consent" data-validate="privacy_consent" data-validation-type="checkboxgrp" class="wrap-area half">
                                ...
                                <div id="mauticform_popupnewslettersignup2023_submit" class="mauticform-row mauticform-button-wrapper mauticform-field-4 wrap-area half">
                        ...
                        <input type="hidden" name="mauticform[formId]" id="mauticform_popupnewslettersignup2023_id" value="23">
                        <input type="hidden" name="mauticform[return]" id="mauticform_popupnewslettersignup2023_return" value="">
                        <input type="hidden" name="mauticform[formName]" id="mauticform_popupnewslettersignup2023_name" value="newslettersignup2023">
