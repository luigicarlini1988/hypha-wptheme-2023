document.addEventListener("DOMContentLoaded", function (event) {
    ...
    const stepAnchor9 = document.getElementById('step9');
    ...
    const counter9 = document.getElementById('step9-counter');
    ...
    window.onscroll = function () {
        ...
        const stepIn9 = stepAnchor9.getBoundingClientRect();
        ...
        //step 9
        if (stepIn9.top >= 0 && stepIn9.bottom <= window.innerHeight) {
            counter8.classList.remove('current');
            counter9.classList.add('current');
