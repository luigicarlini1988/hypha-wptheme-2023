                        ...
                        <div class="form-wrap glow-back">
                            <div class="wrappo">
                                <form autocomplete="false" role="form" method="post"
                                    action="https://mautic.hypha.earth/form/submit?formId=15"
                                    id="mauticform_hyphalabdevelopers" data-mautic-form="hyphalabdevelopers"
                                    ...
                                    <div class="mauticform-innerform">
                                        ...
                                        <div class="mauticform-page-wrapper mauticform-page-1"
                                            ...
                                            <div id="mauticform_hyphalabdevelopers_email" data-validate="email"
                                                ...
                                                <input id="mauticform_input_hyphalabdevelopers_email"
                                                    name="mauticform[email]" value="" class="mauticform-input"
                                                    type="email">
                                                <span class="mauticform-errormsg" style="display: none;">This is
                                                    required.</span>
                                            </div>

                                            <div id="mauticform_hyphalabdevelopers_first_name"
                                                data-validate="first_name" data-validation-type="text"
                                                class="wrap-area half">
                                                ...
                                                <input id="mauticform_input_hyphalabdevelopers_first_name"
                                                    name="mauticform[first_name]" value="" class="mauticform-input"
                                                    type="text">
                                                <span class="mauticform-errormsg" style="display: none;">This is
                                                    required.</span>
                                            </div>
                                            ...
                                            <div id="mauticform_hyphalabdevelopers_last_name" data-validate="last_name"
                                                ...
                                                <input id="mauticform_input_hyphalabdevelopers_last_name"
                                                    name="mauticform[last_name]" value="" class="mauticform-input"
                                                    type="text">
                                                <span class="mauticform-errormsg" style="display: none;">This is
                                                    required.</span>
                                            </div>
                                            ...
                                            <div class="wrap-area half">
                                                <span class="text-12">By sending us a message you agree to our <a
                                                        href="#" class="light-blu">Privacy
                                                        Policy</a></span>
                                            </div>
                                        ...
                                        <input type="hidden" name="mauticform[formId]"
                                            id="mauticform_hyphalabdevelopers_id" value="15">
                                        <input type="hidden" name="mauticform[return]"
                                            id="mauticform_hyphalabdevelopers_return" value="">
                                        <input type="hidden" name="mauticform[formName]"
                                            id="mauticform_hyphalabdevelopers_name" value="hyphalabdevelopers">
                                    </div>
                                </form>
